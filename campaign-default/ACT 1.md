...
- [ ] Red Vale - Activate 3 Obelisks of Rust & Kill **The Rust King** - Take Runed Girdle, Runed Guard and Runed Skull Cap - Portal to Town.
- [ ] Town - Talk to NPCs for Runed Spikes - WP to Grelwood.
...
- [ ] Cemetery - Talk to Lachlann - Enter Mausoleum of the Praetor - Kill **Draven, the Eternal Praetor** - Take Draven's Memorial Key Piece - Go to Cemetery.
- [ ] Cemetery - Enter Tomb of the Consort (opposite WP) - Kill **Asinia, the Praetor's Consort** - Take Asinia's Memorial Key Piece - Go to Cemetery.
- [ ] Cemetery - Talk to Lachlann - Kill **Lachlann of Endless Lament** - Take Count Lachlann's Ring - Portal to Town.
...
- [ ] Ogham Farmlands - Tag WP - Take Una's Lute from Una's Lute Box (before farms) - Go to Ogham Village.
- [ ] *(Once per league)* Ogham Village - Tag WP - Take **Smithing Tools** *(salvage bench)* - Portal to Town - Talk to Renly - Return to Ogham Village.
- [ ] Ogham Village - Kill **The Executioner** *(end of zone)* *(2 skillpoints)* - Use Lever - Talk to Leitis - Go to Manor Ramparts.
