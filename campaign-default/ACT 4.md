...
> **Tip:** Three out of the first four islands are essential for the main quest, but the required islands will change between leagues. One of these four islands also holds Matiki, who needs to be saved to access Eye of Hinekora. The island boss rewards also change between leagues. The optional bosses may be skipped.

## Tasks

- [ ] Town (Kingsmarch) - Talk to NPCs for Book Charter - Talk to Makoru - Sail to Kedge Bay.
- [ ] Kedge Bay - Go to Journey's End.
- [ ] Journey's End - Summon Tujen - Kill **Captain Hartlin** (end of zone) - Take Verisium - Portal to Town.
- [ ] Town - Talk to Dannig for Verisium Spikes - WP to Journey's End.
- [ ] Journey's End - Talk to Freya - Activate Karui Totems - Kill **Omniphobia, Fear Manifest** *(2 skillpoints)* - Portal to Town.
...
- [ ] Abandoned Prison - Kill monsters for Chapel Key - Open Chapel Door - Tag WP - Activate Goddess of Justice *(Flask recovery, can be changed)* - Use Levers - Go to Solitary Confinement.
...
- [ ] Halls of the Dead - Tag WP - Pass Tawhoa's test *(Dex/Lightning Resistance)* - Pass Tasalio's test *(Int/Cold Resistance)* - Pass Ngamahu's test *(Str/Fire Resistance)* - Defeat **Yama The White** - Take Silver Coin - Go to Trial of the Ancestors.
- [ ] Trial of the Ancestors - Tag WP - Talk to Navali - Take Tattoo of Hinekora *(2 skillpoints)* - Return to Ship.
